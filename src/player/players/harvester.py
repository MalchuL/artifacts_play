...
class Harvester(BasePlayer):
    player_type = PlayerType.HARVESTER
    harvest_skills = [SkillType.MINING, SkillType.WOODCUTTING]
    crafting_skills = [SkillType.MINING, SkillType.WOODCUTTING]
