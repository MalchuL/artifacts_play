...
class CanCompleteCraftingTask(CanComplete):
    def __init__(self, player: Player, world: PlaygroundWorld, crafting_skills: List[SkillType]):
    ...
    def can_complete(self, task_info: TaskInfo):
        ...
        crafting_level = self.player.character.stats.skills.get_skill(craft.craft.skill).level
