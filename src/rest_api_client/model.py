...
#   timestamp: 2024-11-09T21:27:06+00:00
...
from pydantic import BaseModel, EmailStr, Field, conint, constr, ConfigDict, RootModel


class AccountLeaderboardType(RootModel):
    root: str = Field(
        'achievements_points', title='AccountLeaderboardType'
    )


class AccountLeaderboardTypeAZAZ09(RootModel):
...
class AchievementTypeAZAZ09(RootModel):
...
class CharacterLeaderboardTypeAZAZ09(RootModel):
...
class CraftSkillAZAZ09(RootModel):
    root: CraftSkill
...
class GatheringSkillAZAZ09(RootModel):
    root: GatheringSkill
...
class ItemTypeAZAZ09(RootModel):
    root: ItemType
...
class MapContentTypeAZAZ09(RootModel):
    root: MapContentType
...
class TaskTypeAZAZ09(RootModel):
    root: TaskType
...
class TaskSchema(BaseModel):
    ...
    rewards: TaskRewardsSchema = Field(
...
class TasksRewardDataSchema(BaseModel):
    cooldown: CooldownSchema = Field(..., description='Cooldown details.')
    rewards: TaskRewardsSchema = Field(..., description='Reward details.')
    character: CharacterSchema = Field(..., description='Player details.')
...
class TasksRewardDataResponseSchema(BaseModel):
