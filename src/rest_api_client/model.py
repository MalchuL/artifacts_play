...
#   filename:  openapiv3.yaml
#   timestamp: 2024-11-05T19:47:13+00:00
...
class AccountDetails(BaseModel):
    ...
    subscribed_until: Optional[int] = Field(
        None,
        description='Subscribed until (in season numbers).',
        title='Subscribed Until',
    )
    founder: bool = Field(..., description='Founder.', title='Founder')
    badges: Optional[List] = Field(None, description='Account badges.', title='Badges')
    gems: Optional[int] = Field(None, description='Gems.', title='Gems')
...
class AchievementSchema(BaseModel):
    ...
    type: Type = Field(..., description='Type of achievement.', title='Type')
...
class BaseachievementResponseSchema(BaseModel):
...
class ChangePassword(BaseModel):
    current_password: constr(pattern=r'^[^\s]+$', min_length=5, max_length=50) = Field(
        ..., description='Current password.', title='Current Password'
    )
...
class DataPageBaseAchievementSchema(BaseModel):
    data: List[BaseAchievementSchema] = Field(..., title='Data')
    total: Optional[conint(ge=0)] = Field(..., title='Total')
    page: Optional[conint(ge=1)] = Field(..., title='Page')
    size: Optional[conint(ge=1)] = Field(..., title='Size')
    pages: Optional[conint(ge=0)] = Field(None, title='Pages')
...
class TaskRewardsSchema(BaseModel):
...
class TaskSchema(BaseModel):
    ...
    type: Type2 = Field(..., description='The type of task.', title='Type')
    total: int = Field(
...
class TasksRewardFullSchema(BaseModel):
    code: str = Field(..., description='Item code.', title='Code')
    min_quantity: int = Field(
        ..., description='Minimum quantity of item.', title='Min Quantity'
    )
    max_quantity: int = Field(
        ..., description='Maximum quantity of item.', title='Max Quantity'
    )
    odds: float = Field(..., description='Item odds.', title='Odds')


class TasksRewardSchema(BaseModel):
    code: str = Field(..., description='Item code.', title='Code')
    quantity: int = Field(..., description='Item quantity.', title='Quantity')
...
class CharacterSchema(BaseModel):
    ...
    consumable1_slot_quantity: conint(ge=0) = Field(
    ...
    consumable2_slot_quantity: conint(ge=0) = Field(
...
class DataPageTasksRewardFullSchema(BaseModel):
    data: List[TasksRewardFullSchema] = Field(..., title='Data')
    total: Optional[conint(ge=0)] = Field(..., title='Total')
    page: Optional[conint(ge=1)] = Field(..., title='Page')
    size: Optional[conint(ge=1)] = Field(..., title='Size')
    pages: Optional[conint(ge=0)] = Field(None, title='Pages')
...
class TaskFullSchema(BaseModel):
    ...
    rewards: TaskRewardsSchema = Field(..., description='Rewards.')
...
class TasksRewardDataSchema(BaseModel):
    cooldown: CooldownSchema = Field(..., description='Cooldown details.')
    reward: TasksRewardSchema = Field(..., description='Reward details.')
    character: CharacterSchema = Field(..., description='Player details.')


class TasksRewardFullResponseSchema(BaseModel):
    data: TasksRewardFullSchema


class TasksRewardResponseSchema(BaseModel):
